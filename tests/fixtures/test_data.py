...
class ChatSessionFactory(factory.DictFactory):
    ...
    def responses(self):
        return {
            ...
            "1": {"answer": "More features please", "question": "What could we improve?"}
        }
...
class ResponseFactory(factory.DictFactory):
    ...
    def demographics(self):
        return {
            ...
            "gender": fake.random_element(["Male", "Female", "Other", "Prefer not to say"])
        }
...
SAMPLE_TEMPLATES = {
    ...
    "employee_survey": {
        ...
        "questions": [
            ...
            {"text": "What would improve your experience?", "type": "text", "enabled": True}
        ]
    }
}
