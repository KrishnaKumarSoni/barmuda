...
class TestDataExtractionAccuracy:
    ...
    def test_complete_conversation_extraction(self, client, mock_db, sample_chat_session):
        ...
        expected_extraction = {
            ...
            "1": {"answer": "Maybe faster response times", "question": "What could we improve?"}
        }
        ...
        with patch('app.db', mock_db), \
            ...
            mock_db.collection.return_value.document.return_value.get.return_value.to_dict.return_value = session_data
            ...
            assert call_args[0][1]['content'] == "I'm very satisfied, I'd say 4 out of 5"
    
    def test_partial_conversation_extraction(self, client, mock_db, sample_chat_session):
        ...
        with patch('app.db', mock_db), \
            ...
            mock_extract.return_value = {
                "0": {"answer": "4", "question": "How satisfied are you?", "partial": True},
    ...
    def test_conflicting_answers_latest_wins(self, mock_db):
        ...
        with patch('data_extraction.openai_client') as mock_openai:
            ...
            form_data = {"questions": [{"text": "Do you like coffee?", "type": "yes_no"}]}
    ...
    def test_no_fit_response_bucketing(self, mock_db):
        ...
        no_fit_transcript = [
            {"role": "assistant", "content": "What's your favorite color? (red, blue, green)"},
    ...
    def test_multi_answer_parsing_accuracy(self, mock_db):
        ...
        multi_answer_transcript = [
            ...
            {"role": "assistant", "content": "Noted your name, Alex! I'll use the age and location later."}
        ]
    ...
    def test_extraction_error_handling(self, mock_db):
        ...
        with patch('data_extraction.openai_client') as mock_openai:
            ...
            mock_openai.chat.completions.create.side_effect = [
                Exception("API Error"),
                Mock(choices=[Mock(message=Mock(content=json.dumps({"responses": {}})))])
            ]
