...
class TestAuthenticationFlow:
    ...
    def test_google_auth_retrieves_existing_user(self, client, mock_db):
        ...
        with patch('firebase_admin.auth.verify_id_token') as mock_verify, \
            ...
            mock_db.collection.return_value.document.return_value.get.return_value.to_dict.return_value = existing_profile
    ...
    def test_protected_routes_allow_authenticated_users(self, authenticated_session, mock_db):
    ...
    def test_user_profile_api_endpoint(self, authenticated_session, mock_db):
        ...
        with patch('app.db', mock_db):
            mock_db.collection.return_value.document.return_value.get.return_value.exists = True
            mock_db.collection.return_value.document.return_value.get.return_value.to_dict.return_value = profile_data
    ...
    def test_session_persistence_across_requests(self, client, mock_db):
        ...
        with patch('firebase_admin.auth.verify_id_token') as mock_verify, \
            ...
            # Authenticate
            auth_response = client.post('/auth/google',
                json={'idToken': 'valid_token'})
