...
class BermudaProductionTester:
    ...
    def test_form_inference_direct(self):
        ...
        try:
            ...
            if response.status_code == 401:
                self.log_test("Form Inference API", False, "Authentication required (expected)")
                return False
            ...
            self.log_test("Form Inference API", success, 
    ...
    def test_chat_start(self):
        ...
        try:
            ...
            self.log_test("Chat Session Start", success, 
    ...
    def test_edge_case_scenarios(self):
        ...
        for case in edge_cases:
            try:
                ...
                success = response.status_code in [400, 404, 500]  # Expected error codes
                
                self.log_test(f"Edge Case: {case['name']}", success, 
    ...
    def test_response_endpoints(self):
        ...
        for endpoint in endpoints_to_test:
            try:
                ...
                self.log_test(f"Response Endpoint: {endpoint}", success,
                             f"Status: {response.status_code} (endpoint exists)")
                             
            except Exception as e:
                self.log_test(f"Response Endpoint: {endpoint}", False, f"Error: {str(e)}")
    ...
    def generate_report(self):
        ...
        print(f"   • Homepage: {'✅ Working' if any(r['test'] == 'Homepage Load' and r['success'] for r in self.test_results) else '❌ Issues'}")
        print(f"   • API Endpoints: {'✅ Available' if passed_tests > failed_tests else '❌ Issues'}")
