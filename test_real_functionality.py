        ...
        try:
            ...
            expected_structure = {
                ...
                "questions": [
                    ...
                    {
                        "text": "How do you prefer your coffee brewed?",
                        "type": "multiple_choice",
                    },
                    {
                    ...
                    {
                        "text": "What's your typical coffee budget per visit?",
                        "type": "number",
                    },
    ...
    def test_chat_interface_simulation(self):
        ...
        try:
            ...
            for i, message in enumerate(edge_case_messages, 1):
                msg_payload = {"session_id": "test-session-123", "message": message}
                ...
                print(
                    f"      Message {i}: '{message[:30]}...' → Status {response.status_code}"
                )
