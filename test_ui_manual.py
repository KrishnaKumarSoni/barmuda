...
class BermudaManualUITester:
    ...
    def test_homepage_structure(self):
        ...
        try:
            ...
            checks = {
                ...
                "Hero Section": any(x in html for x in ["hero", "text-4xl", "text-5xl"]),
            ...
            details = f"{passed}/{total} elements found: " + ", ".join([f"{k}:{'✅' if v else '❌'}" for k, v in checks.items()])
    ...
    def test_form_creation_page_access(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log_test("Form Creation Page Access", success, 
                             f"Accessible without auth - Elements: {passed}/5")
                return success
            else:
                # Check if it's an auth redirect
                auth_required = response.status_code in [401, 403] or "auth" in response.text.lower()
                
                self.log_test("Form Creation Page Access", auth_required, 
    ...
    def test_chat_page_structure(self):
        ...
        try:
            ...
            if response.status_code == 404:
                ...
                self.log_test("Chat Page 404 Handling", success,
                             f"404 page elements: {passed}/4")
                return success
            else:
                # If we get actual chat page, check its structure
                chat_elements = {
                    "Chat Container": any(x in html for x in ["chat", "message", "conversation"]),
                    "Input Field": "input" in html.lower(),
                    "Send Button": "send" in html.lower() or "submit" in html.lower(),
                    "WebSocket/Realtime": any(x in html for x in ["socket", "realtime", "firebase"]),
                ...
                self.log_test("Chat Page Structure", success,
                             f"Chat elements: {passed}/5")
                return success
    ...
    def test_figma_design_elements(self):
        ...
        try:
            ...
            design_elements = {
                ...
                "Orange Color Scheme": any(x in html for x in ["orange", "#cc5500", "#e17d36"]),
                "Rounded Elements": "rounded" in html,
                "Gradient Buttons": "gradient" in html,
                "Custom Colors": any(x in html for x in ["#fef5e0", "#fbe7bd", "#bermuda"]),
                "Phosphor Icons": "phosphor" in html.lower(),
                "Figma Assets": any(x in html for x in [".svg", ".png"]) and "static" in html
            }
    ...
    def test_responsive_design_meta(self):
        ...
        try:
            ...
            responsive_elements = {
                ...
                "Tailwind Responsive": any(x in html for x in ["sm:", "md:", "lg:", "xl:"]),
    ...
    def test_performance_indicators(self):
        ...
        try:
            ...
            performance_indicators = {
                ...
                "Proper Caching": 'max-age' in response.headers.get('cache-control', ''),
    ...
    def test_dashboard_access(self):
        ...
        try:
            ...
            if auth_required:
                self.log_test("Dashboard Access Control", True, 
                ...
                dashboard_elements = {
                    ...
                    "Statistics": any(x in html for x in ["stats", "analytics", "total"]),
                ...
                self.log_test("Dashboard Elements", success,
                             f"Dashboard elements: {passed}/4")
                return success
