"""
Barmuda Chat Agent - Agentic Chatbot for Form Collection
...
Use your tools to manage the conversation flow and data collection effectively."""
    ...
    def get_next_question(self, session_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # No more questions
            return {"question_index": -1, "question_text": None, "all_complete": True}
    ...
    def validate_response(
        self, response: str, question_type: str, options: List[str] = None
    ) -> Dict[str, Any]:
                    ...
                    if numbers:
                        ...
                        if 1 <= rating <= 5:
                            return {
                                "valid": True,
                                "normalized": rating,
                                "message": f"Rating {rating} accepted",
                            }
                        else:
                            return {
                                "valid": False,
                                "message": "Please rate between 1-5",
                            }
                    else:
                        # Handle word ratings
                        rating_map = {
                        ...
                        for word, rating in rating_map.items():
                            if word in response_lower:
                                return {
                                    "valid": True,
                                    "normalized": rating,
                                    "message": f'Rating {rating} from "{word}"',
                                }

                        return {
                            "valid": False,
                            "message": "Please provide a rating 1-5 or descriptive word",
                        }
                except:
    ...
    @function_tool
    def redirect_conversation(
        self, session_id: str, off_topic_response: str
    ) -> Dict[str, Any]:
    ...
    def clarify_response(self, response: str, question_type: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "clarification": clarification_templates.get(
                    question_type, "Could you be more specific? 😊"
                ),
    ...
    def end_conversation(
        self, session_id: str, reason: str = "completion"
    ) -> Dict[str, Any]:
    ...
    @function_tool
    def save_response(
        self, session_id: str, question_index: int, response_value: Any
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if session_doc.exists:
                ...
                return ChatSession(
                    ...
                    current_question_index=session_data.get(
    ...
    def _save_session(self, session: ChatSession):
        ...
        try:
            ...
            if session.metadata.get("ended", False):
                firestore_db.collection("chat_responses").document(
                    session.session_id
                ).set(session_data)
